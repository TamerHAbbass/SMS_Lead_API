...
class SMS_Lead_Data(models.Model):
    ...
    UploadedToVoiceCampaign = models.CharField(max_length=255, db_index=True)
    ContactCallable = models.CharField(max_length=255, db_index=True)
    UploadedToVoiceCampaign = models.CharField(max_length=255, db_index=True)
    ZipCodeAutomaticTimeZone = models.CharField(max_length=255, db_index=True)
    CallRecordLastAttempt_Number = models.CharField(max_length=255, db_index=True)
    ...
    def __int__(self):
        return self.uuid
			...
			CallRecordLastResult-Number	CallRecordLastAgentWrapup-Number	SmsLastAttempt-Number	SmsLastResult-Number	Callable-Number	AutomaticTimeZone-Number

...
class Campaign(models.Model):
    ...
    start = models.CharField(max_length=254, null=True, db_index=True, blank=True)
    end = models.CharField(max_length=254, null=True, db_index=True, blank=True)
...
class SMS_Lead_Data(models.Model):
    ...
    Timezone = models.CharField(max_length=80, db_index=True, blank=True)
    First = models.CharField(max_length=100, db_index=True, blank=True)
    Last = models.CharField(max_length=100, db_index=True, blank=True)
    Address = models.CharField(max_length=254, db_index=True, blank=True)
    City = models.CharField(max_length=254, db_index=True, blank=True)
    State = models.CharField(max_length=254, db_index=True, blank=True)
    Zip = models.CharField(max_length=254, db_index=True, blank=True)
    PropertyID = models.CharField(max_length=254, db_index=True, blank=True)
    UploadDate = models.CharField(max_length=254, db_index=True, blank=True)
    SMSMessage1 = models.CharField(max_length=511, db_index=True, blank=True)

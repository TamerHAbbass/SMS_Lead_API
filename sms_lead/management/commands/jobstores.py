...
from sms_lead.models import DjangoJob, DjangoJobExecution
from sms_lead.management.commands.util import (
...
class DjangoResultStoreMixin:
    ...
    @classmethod
    def handle_execution_event(cls, event: JobExecutionEvent):
        """
    ...
    @classmethod
    def handle_error_event(cls, event: JobExecutionEvent):
        """
